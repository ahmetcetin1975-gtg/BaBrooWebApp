...
export function PackagesPage({ lang }: { lang: "tr" | "en" }) {
  ...
  return (
    <>
      <section className="relative table w-full py-36 bg-[url('/assets/images/gotradego/payment.png')] bg-center bg-no-repeat bg-cover">
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 pb-8 text-center mt-10">
            <h3 className="md:text-4xl text-3xl md:leading-normal tracking-wide leading-normal font-medium text-white">{t("LCOD_LBL_PACKAGES")}</h3>
          </div>
        </div>
      ...
      <section className="relative md:py-8 py-8 overflow-hidden mb-20">
        <Packages />
      </section>
    </>
  );
